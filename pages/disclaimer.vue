    ...
    <main class="bg-[#0b1026]">
        ...
        <div class="text-gray-400 flex flex-col gap-12 p-8 md:p-16">
            ...
            <p class="text-xl md:text-2xl font-light">
                ...
                so it's the only way available currently. Here's their <a href="https://www.patreon.com/sketchware">Patreon</a> page.
            ...
            <br />
                ...
                recommended to use the official version of Sketchware if you are a beginner. Sketchware Pro is for advanced
                users who want to use the latest features and bug fixes.
            </p>
